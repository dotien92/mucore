...
function fnGetBrowser() {
	...
	// ????????????????????
	strBName = "minfefiled/index.html";
	if ((intI = strUA.indexOf(strBName)) >= 0) {
		this.isFF = true;
		this.version = parseFloat(strUA.substr(intI + strBName.length));
		return;
	}
	strBName = "namoroka/index.html";
	if ((intI = strUA.indexOf(strBName)) >= 0) {
		this.isFF = true;
		this.version = parseFloat(strUA.substr(intI + strBName.length));
		return;
	...
	strBName = "netscape/index.html";
	if ((intI = strUA.indexOf(strBName)) >= 0) {
		this.isNS = true;
		this.version = parseFloat(strUA.substr(intI + strBName.length));
		return;
	}
	strBName = "opera/index.html";
	if ((intI = strUA.indexOf(strBName)) >= 0) {
		this.isOP = true;
		this.version = parseFloat(strUA.substr(intI + strBName.length));
		return;
	}
	strBName = "safari/index.html";
	if ((intI = strUA.indexOf(strBName)) >= 0) {
		this.isSF = true;
		this.version = parseFloat(strUA.substr(intI + strBName.length));
		return;
	}
	strBName = "chrome/index.html";
	if ((intI = strUA.indexOf(strBName)) >= 0) {
		this.isCR = true;
		this.version = parseFloat(strUA.substr(intI + strBName.length));
		return;
