...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" name="vote_url"></td>
</tr>
...
<input type="submit" value="Add Vote Link"></td>
</tr>
...
<tr>
<td align="left" class="panel_text_alt1" width="50%">Enter the URL of vote.</td>
<td align="left" class="panel_text_alt2" width="50%"><input type="text" name="vote_url" value="' . $vote_url . '"></td>
</tr>
...
<input type="submit" value="Edit Vote Link"></td>
</tr>
...
<tr>';
            if ($get_config->active == '1') {
                echo '<td align="left" class="panel_buttons" style="background: #0C0;"><b>Vote Credits is active.</b></td>
<td align="right" class="panel_buttons" style="background: #0C0;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Vote Credits Off"><input type="hidden" name="module_active" value="0">';
                
                
            } elseif ($get_config->active == '0') {
                echo '<td align="left" class="panel_buttons" style="background: #C00;"><b>Vote Credits is inactive.</b></td>
<td align="right" class="panel_buttons" style="background: #C00;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Vote Credits On"><input type="hidden" name="module_active" value="1">';
            }
            echo '</td>
</tr>
</table>
...
<input type="text" value="' . $get_config->delay_hours . '" name="delay_hours"><br>
</td>
</tr>
...
<input type="button" value="Add Vote Link" onclick="location.href=\'index.php?get=vote_credits_manager&m=add\'"></td>
</tr>
</table>';
        }
    }
