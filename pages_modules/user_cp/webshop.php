...
if($webshop_settings->active == '0'){
        ...
        $credits_socket1 = $webshop_settings->credits_socket1;
                ...
                if($item->EOF){
                    ...
                    if($item->fields[9] == 0 || empty($item->fields[9])){
                        ...
                        if($item->fields[0] != '1'){
                            ...
                            if ($_POST['item_socket1'] >= 0 && $_POST['item_socket1'] < 255 && $item->fields[23] == '1') {
                            ...
                            if ($_POST['item_socket2'] >= 0 && $_POST['item_socket2'] < 255 && $item->fields[23] == '1') {
                            ...
                            if ($_POST['item_socket3'] >= 0 && $_POST['item_socket3'] < 255 && $item->fields[23] == '1') {
                            ...
                            if ($_POST['item_socket4'] >= 0 && $_POST['item_socket4'] < 255 && $item->fields[23] == '1') {
                            ...
                            if ($_POST['item_socket5'] >= 0 && $_POST['item_socket5'] < 255 && $item->fields[23] == '1') {
                            ...
                            if($item->fields[10] == 2 || $item->fields[10] == 4 || $item->fields[10] == 6 || $item->fields[10] == 8 || $item->fields[10] == 10 || $item->fields[10] == 12 || $item->fields[10] == 14 || $item->fields[10] == 16 || $item->fields[10] == 18 || $item->fields[10] == 20 || $item->fields[10] == 22 || $item->fields[10] == 24 || $item->fields[10] == 26 || $item->fields[10] == 28 || $item->fields[10] == 30 || $item->fields[10] == 32 || $item->fields[10] == 34 || $item->fields[10] == 36 || $item->fields[10] == 38) {
                              if ($ianc==1){
                            ...
                            if ($item->fields[7] != 0) {
                                ...
                                if (@$_POST["item_option1"] == "1") {
                                        ...
                                        switch ($item->fields[7]) {
                                                ...
                                                case 5: $rq_credits+=$credits_fenrir_black; break;
                                        }
                                }
                            ...
                            if (@$_POST["item_option2"] == "1") {
                                        ...
                                        switch ($item->fields[7]) {
                                                ...
                                                case 5: $rq_credits+=$credits_fenrir_blue; break;
                                        }
                                }
                            ...
                            if (@$_POST["item_option3"] == "1") {
                                        ...
                                        switch ($item->fields[7]) {
                                                ...
                                                case 5: $rq_credits+=$credits_fenrir_golden; break;
                                        }
                                }
                            ...
                            if ($item_new_serial == 1) {
                                $serial_take =  $core_db->Execute("exec WZ_GetItemSerial2 1");
                            ...
                            if($item->fields[23] == '1') {
                              $itemhex    .= sprintf("%02X",$addsocket1,00);
                              $itemhex    .= sprintf("%02X",$addsocket2,00);
                              $itemhex    .= sprintf("%02X",$addsocket3,00);
                              $itemhex    .= sprintf("%02X",$addsocket4,00);
                              $itemhex    .= sprintf("%02X",$addsocket5,00);
                            }
                            else
                              $itemhex    .= "FFFFFFFFFF"; 
                            ...
                            while ($i<120) {
                                $query = $core_db->Execute("select substring(Items,".($i*32+1).",32) from warehouse where AccountID=?",array($user_auth_id));
                                $i++;
                            ...
                            $test               = $slot*64;
                                        ...
                                        echo $error_message;
                                            ...
                                            if($item->fields[11] == 1 && $item->fields[23] != '1'){
                                                echo '
                                            ...
                                            if($item->fields[23] == '1'){
                                                ...
                                                update_amount=document.getElementById(\'credits_socket1\').innerHTML;
                                                        if (update_amount>0){
                                                                amount+=parseInt(update_amount);
                                                                }
                                                update_amount=document.getElementById(\'credits_socket2\').innerHTML;
                                                        if (update_amount>0){
                                                                amount+=parseInt(update_amount);
                                                                }
                                                update_amount=document.getElementById(\'credits_socket3\').innerHTML;
                                                        if (update_amount>0){
                                                                amount+=parseInt(update_amount);
                                                                }                
                                                update_amount=document.getElementById(\'credits_socket4\').innerHTML;
                                                        if (update_amount>0){
                                                                amount+=parseInt(update_amount);
                                                                }                
                                                update_amount=document.getElementById(\'credits_socket5\').innerHTML;
                                                        if (update_amount>0){
                                                                amount+=parseInt(update_amount);
                                                                }                
                                           ...
                                           if($item->fields[7] == 1){
                                                ...
                                                value_option6='.$credits_wn6.';
                                                ';
                                           }elseif($item->fields[7] == 5){
                                                echo '
                                                value_option1='.$credits_fenrir_black.';
                                                value_option2='.$credits_fenrir_blue.';
                                                value_option3='.$credits_fenrir_golden.';
                                                value_option4=0;
                                                value_option5=0;
                                                value_option6=0;
                                                ';
                            ...
                            <form action="" method="POST" name="buy_item">
                                ...
                                <td align="left"><select name="level" id="level" onKeyUp="javascript:item_level();" onChange="javascript:item_level();">
                                                        ...
                                                        if(!empty($item->fields[4])){
                                                                echo '
                                                        <tr>
                                <td align="left" width="200"><b>Item level2:</b></td>
                                <td align="left">+'.$item->fields[4].'</td></tr>';
                                               ...
                                               if($item->fields[7] == '5'){
                                                        ...
                                                        <td align="lett"><label><input type="checkbox" name="item_option0" id="item_option0" onChange="javascript:check_options();" value="0"> Yes</lable> <span id="credits_option0_css" class="shop_credits_disabled"><span id="credits_option0">0</span> Credits</span></td>
                                                        </tr>';
                                                }
                                ...
                                <option value="8">SD Rate</option>';
                                                ...
                                                if($item->fields[23] == '1') {
                                                echo '<tr>
                                                        <td align="left"><b>Socket 1:</b></td>
                                                        <td align="left">
                                                        <select name="item_socket1" id="item_socket1" onKeyUp="javascript:check_socket1();" onChange="javascript:check_socket1();">
                                                        <option value="255">None</option>
                                                        <option value="254">Empty</option>
                                                        <!--<option value="0">Fire(Level type)(Increases Attack & Wizardry +20)</option>
                                                        <option value="1">Fire(Increases Attack Speed +7)</option>
                                                        <option value="2">Fire(Increases Maximum Attack & Wizardry +30)</option>
                                                        <option value="3">Fire(Increases Minimum Attack & Wizardry +20)</option>
                                                        <option value="4">Fire(Increases Attack & Wizardry +20)</option>
                                                        <option value="5">Fire(AG cost decrease +40%)</option>
                                                        <option value="10">Water(Block rating increase +10%)</option>
                                                        <option value="11">Water(Defence increase +30)</option>
                                                        <option value="12">Water(Shield protection increase +7%)</option>
                                                        <option value="13">Water(Damage reduction +4%)</option>
                                                        <option value="14">Water(Damage reflection +5%)</option>
                                                        <option value="16">Ice(HP incerase after kill monster +8)</option>
                                                        <option value="17">Ice(Mana incerase after kill monster +8)</option>
                                                        <option value="18">Ice(Skill attack increase +37)</option>
                                                        <option value="19">Ice(Attack rating increase +25)</option>
                                                        <option value="20">Ice(Item durability increase +30%)</option>
                                                        <option value="21">Wind(Automatic HP recovery increase +8)</option>
                                                        <option value="22">Wind(Maximum HP increase +4%)</option>
                                                        <option value="23">Wind(Maximum Mana increase +4%)</option>
                                                        <option value="24">Wind(Automatic Mana recovery increase +7)</option>
                                                        <option value="25">Wind(Maximum AG increase +25)</option>
                                                        <option value="26">Wind(AG value increase +3)</option>
                                                        <option value="29">Lighting(Excellent damage increase +15)</option>
                                                        <option value="30">Lighting(Excellent damage rate +10%)</option>
                                                        <option value="31">Lighting(Critical damage increase +30)</option>
                                                        <option value="32">Lighting(Critical damage rate +8%)</option>
                                                        <option value="36">Earth(Stamina increase +30)</option>-->
                                                        </select> 
                                                        <span id="credits_socket1_css" class="shop_credits_disabled"><span id="credits_socket1">0</span> Credits</span>
                                                        </td>
                                                      </tr>
                                                      
                                                      <tr>
                                                        <td align="left"><b>Socket 2:</b></td>
                                                        <td align="left">
                                                        <select name="item_socket2" id="item_socket2" onKeyUp="javascript:check_socket2();" onChange="javascript:check_socket2();">
                                                        <option value="255">None</option>
                                                        <option value="254">Empty</option>
                                                        <!-- value="1">Fire(Increases Attack Speed +7)</option>
                                                        <option value="2">Fire(Increases Maximum Attack & Wizardry +30)</option>
                                                        <option value="3">Fire(Increases Minimum Attack & Wizardry +20)</option>
                                                        <option value="4">Fire(Increases Attack & Wizardry +20)</option>
                                                        <option value="5">Fire(AG cost decrease +40%)</option>
                                                        ...
                                                        <span id="credits_socket2_css" class="shop_credits_disabled"><span id="credits_socket2">0</span> Credits</span>
                                                        </td>
                                                      </tr>
                                                      
                                                      <tr>
                                                        <td align="left"><b>Socket 3:</b></td>
                                                        <td align="left">
                                                        <select name="item_socket3" id="item_socket3" onKeyUp="javascript:check_socket3();" onChange="javascript:check_socket3();">
                                                        <option value="255">None</option>
                                                        <option value="254">Empty</option>
                                                        <!--<option value="0">Fire(Level type)(Increases Attack & Wizardry +20)</option>
                                                        <option value="1">Fire(Increases Attack Speed +7)</option>
                                                        ...
                                                        <span id="credits_socket3_css" class="shop_credits_disabled"><span id="credits_socket3">0</span> Credits</span>
                                                        </td>
                                                      </tr>
                                                      
                                                      <tr>
                                                        <td align="left"><b>Socket 4:</b></td>
                                                        <td align="left">
                                                        <select name="item_socket4" id="item_socket4" onKeyUp="javascript:check_socket4();" onChange="javascript:check_socket4();">
                                                        <option value="255">None</option>
                                                        <option value="254">Empty</option>
                                                        <!--<option value="0">Fire(Level type)(Increases Attack & Wizardry +20)</option>
                                                        <option value="1">Fire(Increases Attack Speed +7)</option>
                                                        ...
                                                        <span id="credits_socket4_css" class="shop_credits_disabled"><span id="credits_socket4">0</span> Credits</span>
                                                        </td>
                                                      </tr>
                                                      
                                                      <tr>
                                                        <td align="left"><b>Socket 5:</b></td>
                                                        <td align="left">
                                                        <select name="item_socket5" id="item_socket5" onKeyUp="javascript:check_socket5();" onChange="javascript:check_socket5();">
                                                        <option value="255">None</option>
                                                        <option value="254">Empty</option>
                                                        <!--<option value="0">Fire(Level type)(Increases Attack & Wizardry +20)</option>
                                                        <option value="1">Fire(Increases Attack Speed +7)</option>
                                                        ...
                                                        <span id="credits_socket5_css" class="shop_credits_disabled"><span id="credits_socket5">0</span> Credits</span>
                                                        </td>
                                                      </tr>
