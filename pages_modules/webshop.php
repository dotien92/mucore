		...
		if($item->EOF){
			...
			if($item->fields[0] != '1'){
				...
				if(is_numeric($item->fields[1]) && $item->fields[1] <= 0){
		            ...
		            while ($i<120) {
		            	$query = $core_db->Execute("select substring(Items,".($i*64+1).",64) from warehouse where AccountID=?",$_COOKIE['auth_user']);
		            	$i++;
					...
					$take_credits = $core_db2->Execute("Select credits from MEMB_CREDITS where memb___id=?",$_COOKIE['auth_user']);
					...
					if ($noadd != 1) {
						$update_credits = $core_db2->Execute("Update MEMB_CREDITS set credits=(credits-?) where memb___id=?",array($rq_credits,$_COOKIE['auth_user']));
						$insert_item = $core_db->Execute("update warehouse set Items=".substr_replace($mycuritems, $itemhex, ($test+2), 64)." where AccountID=?",$_COOKIE['auth_user']);
						if($item->fields[1] > 0){
							$update_stock = $core_db->Execute("Update MUCore_Shop_Items set i_stock=(i_stock-1) where id=?",array($item->fields[21]));
						}
						webshop_log($_COOKIE['auth_user'],$itemhex,'Purchased '.$item->fields[2].' for '.number_format($rq_credits).' credits.');
...
if (document.buy_item.item_option1.checked)
{NewCount = NewCount + 1}

if (document.buy_item.item_option2.checked)
{NewCount = NewCount + 1}

if (document.buy_item.item_option3.checked)
{NewCount = NewCount + 1}

if (document.buy_item.item_option4.checked)
{NewCount = NewCount + 1}

if (document.buy_item.item_option5.checked)
{NewCount = NewCount + 1}

if (document.buy_item.item_option6.checked)
{NewCount = NewCount + 1}
if (NewCount == 5000)
{

alert("Pick Just 4 Please")
document.buy_item; return false;
}
} 
						   </script>
				...
				<table class="nyd_table">
				<tr><th>'.htmlentities($item->fields[2]).'</th></tr></table><br>';
			  /*  if($item->fields[10] != 0){
				...
				<table class="nyd_table" width="100%" border="0" align="center" cellpadding="0" cellspacing="4">
				';
				...
				<td align="left">+'.$item->fields[4].'</td></tr>';
						...
						if($item->fields[7] == '1'){
							...
							<td align="lett"><label><input type="checkbox" name="item_option6" id="item_option6" onClick="return KeepCount()" onChange="javascript:check_options();" value="1"> Yes</lable> <span id="credits_option6_css" class="shop_credits_disabled"><span id="credits_option6">0</span> Credits</span></td>
							</tr>';
						}elseif($item->fields[7] == '2'){
							echo '<tr>
							...
							<td align="lett"><label><input type="checkbox"  name="item_option1" id="item_option1" onClick="return KeepCount()" onChange="javascript:check_options();" value="1"> Yes</lable> <span id="credits_option1_css" class="shop_credits_disabled"><span id="credits_option1">0</span> Credits</span></td>
							</tr>';
						}elseif($item->fields[7] == '4'){
							echo '<tr>
						...
						if($item->fields[7] == '1'){
							...
							<td align="lett"><label><input type="checkbox" name="item_option5" id="item_option5" onClick="return KeepCount()" onChange="javascript:check_options();" value="1"> Yes</lable> <span id="credits_option5_css" class="shop_credits_disabled"><span id="credits_option5">0</span> Credits</span></td>
							</tr>';
						}elseif($item->fields[7] == '2'){
							echo '<tr>
							...
							<td align="lett"><label><input type="checkbox" name="item_option2" id="item_option2" onClick="return KeepCount()" onChange="javascript:check_options();" value="1"> Yes</lable> <span id="credits_option2_css" class="shop_credits_disabled"><span id="credits_option2">0</span> Credits</span></td>
							</tr>';
						}elseif($item->fields[7] == '4'){
							echo '<tr>
						...
						if($item->fields[7] == '1'){
							...
							<td align="lett"><label><input type="checkbox" name="item_option4" id="item_option4" onClick="return KeepCount()" onChange="javascript:check_options();" value="1"> Yes</lable> <span id="credits_option4_css" class="shop_credits_disabled"><span id="credits_option4">0</span> Credits</span></td>
							</tr>';
						}elseif($item->fields[7] == '2'){
							echo '<tr>
							...
							<td align="lett"><label><input type="checkbox" name="item_option3" id="item_option3" onClick="return KeepCount()" onChange="javascript:check_options();" value="1"> Yes</lable> <span id="credits_option3_css" class="shop_credits_disabled"><span id="credits_option3">0</span> Credits</span></td>
							</tr>';
						}elseif($item->fields[7] == '4'){
							echo '<tr>
