...
elseif($dato=="lista2"){
    ...
    if($id=='NUEVO'){
        ...
        for($j=0;$j<8;$j++){
            ...
            $r .= "{e:0,i:".$j.",o0:1".$valor1.",o1:2".$valor2.",o2:1".$valor3.",o3:1".$valor4.",o4:2".$valor5.",o5:1".$valor6.",o6:1".$valor7.",o7:1".$valor8.",o8:1".$valor9.",o9:1".$valor10.",o10:1".$valor11."},\n";
        }
    }
    echo  '{"datos": ['.substr_replace ($r, '', -2).']}';
}
elseif($dato=="lista3"){
    ...
    if($id=='NUEVO'){
        ...
        for($j=0;$j<8;$j++){
            ...
            $valor10= decoBmd2(1,substr($contenido, $id * 656 + $l_head * 4 + $j * 40 + 364, 4), 364 + $j * 40, 4, 0);
            $valor11= decoBmd2(1,substr($contenido, $id * 656 + $l_head * 4 + $j * 40 + 368, 4), 368 + $j * 40, 4, 0);
            $r .= "{e:0,i:".$j.",o0:1".$valor1.",o1:2".$valor2.",o2:2".$valor3.",o3:1".$valor4.",o4:1".$valor5.",o5:1".$valor6.",o6:1".$valor7.",o7:1".$valor8.",o8:1".$valor9.",o9:1".$valor10.",o10:1".$valor11."},\n";
        }
    }
    echo  '{"datos": ['.substr_replace ($r, '', -2).']}';
}?>