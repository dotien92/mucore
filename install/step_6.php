...
echo '"> ' . $w_title . '</td></tr><tr>
<td align="left" class="panel_title_sub" colspan="2">MU Online databsae use MD5 Encryption: <b style="color: red;">file Dll Lib on Install/WZ_MD5_MOD<br/>
<b>If use MD5, Copy WZ_MD5_MOD.dll to C:\Program Files\Microsoft SQL Server\MSSQL\Binn<br/>
AND Run SQL QUERY: WZ_MD5_MOD.sql on SQL Server Management Studio/SQL Query Analyzer</b>
</td></tr>
<tr><td align="left" class="panel_text_alt1" width="45%" valign="top">When \'Yes\' website will perform functions,checks,features under MD5 encryption method.</td>
<td align="left" class="panel_text_alt2" width="45%" valign="top">';

if (isset($_POST['md5'])) {
    switch ($_POST['md5']) {
    case '0' : echo '<label><input type="radio" name="md5" value="1">Yes</label> <label><input type="radio" name="md5" checked="checked" value="0">No</label>';
    break;

case '1':
    echo '<label><input type="radio" name="md5" value="1">Yes</label> 
<label><input type="radio" name="md5" value="0" checked="checked">No</label>';
    break;
}
}
else {
    echo '<label><input type="radio" name="md5" value="1">Yes</label> <label><input type="radio" name="md5" value="0" checked="checked">No</label>';
}

echo '</td></tr>
<tr><td align="left" class="panel_title_sub" colspan="2">Encrypt Key</td></tr>
<tr><td align="left" class="panel_text_alt1" width="45%" valign="top">Provide an encryption key, <b>8 digits length, letters and nubmers only</b>.<br />Encryption key will be used in website features and functions in order to protect your users data.</b></td><td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" name="c_key" maxlength="8" value="' . $_POST['c_key'] . '"> ' . $c_key . '</td></tr>
<tr><td align="left" class="panel_title_sub" colspan="2">Administrator Nickname</td></tr><tr><td align="left" class="panel_text_alt1" width="45%" valign="top">Enter an nickname for your Administrator account. (letters,numbers and spaces only)</b></td><td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" name="w_nick" value="' . $_POST['w_nick'] . '"> ' . $w_nick . '</td></tr><tr><td align="left" class="panel_title_sub" colspan="2">Webmaster\'s Email</td></tr><tr><td align="left" class="panel_text_alt1" width="45%" valign="top">This is the email address of the webmaster. It will be used as the From address for certain emails sent by the system.</b></td><td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" name="master_mail" value="' . $_POST['master_mail'] . '"> ' . $master_mail . '</td></tr><tr><td align="left" class="panel_title_sub" colspan="2">Template</td></tr><tr><td align="left" class="panel_text_alt1" width="45%" valign="top">Select website template.<br /><br />Note: each template</b>has his own folder that is stored on <b>template</b> folder.</td> <td align="left" class="panel_text_alt2" width="45%" valign="top"><select name="template"><option value="0" >Choose a template</option><optgroup label="---------------">';
