...
<tr><td align="center" class="panel_title" colspan="2">Connection Info</td></tr>
<tr><tr><td align="left" class="panel_title_sub" colspan="2">Connection Type</td></tr>
<tr><td align="left" class="panel_text_alt1" width="80%">MUCore will connect to database using the next connection type.</td>
<td align="left" class="panel_text_alt2" width="20%" valign="top"><b>' . $core['connection_type'] . '</b></td>
</tr><tr><td align="left" class="panel_title_sub" colspan="2">Server Databases</td></tr>
<tr><td align="left" class="panel_text_alt1" width="80%">MUCOre will connect to the following databases.<br />
...
<br />All this configs can be made from <b>config.php</b></td>
<td align="left" class="panel_text_alt2" width="20%" valign="top"><b>';
...
if ($core['server_use_2_db'] == '1') {
    echo '<tr><td align="left" class="panel_title_sub" colspan="2">' . $core['db_name2'] . '</td></tr><tr><td align="left" class="panel_text_alt1" width="80%">Connection with ' . $core['db_name2'] . ' Database</td><td align="left" class="panel_text_alt2" width="20%" valign="top">';
    if ($core['connection_type'] == "ODBC") {
