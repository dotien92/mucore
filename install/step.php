...
echo '<form action="" name="form_edit" method="POST"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_panel"><tr> <td align="center" class="panel_title" colspan="2">MUCore Serial Number</td></tr><tr><td align="left" class="panel_title_sub" colspan="2">Serial Number</td></tr><tr><td align="left" class="panel_text_alt1" width="45%" valign="top">Input a Serial Number (20 digits). Skip this step click Next </td><td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" name="w_sn" value="';
